...
def tuning():
    ...
    return {
        ...
        'is_abstract': False,
        'properties': [
            ('global_mean_metrics_used', 'str', '0.1',
                "Describe the metrics of the global mean state used in tuning model parameters."),
            ('regional_metrics_used', 'str', '0.1',
                "Which regional metrics of mean state (e.g Monsoons, tropical means etc) have been used in tuning."),
            ('trend_metrics_used', 'str', '0.1',
...
def grid():
    ...
    return {
        ...
        'properties': [
            ...
            ('detail_sets', 'science.detail_set', '0.N',
